...
Agent 协议是 Ooder 平台中 MCP Agent、Route Agent 和 End Agent 之间的通信协议，属于南向协议的具体实现。v2.3 版本在 v0.8.0 基础上进行了全面升级，统一了能力发现抽象层，简化了架构，提升了可维护性。
...
| 版本 | 发布日期 | 主要变更 |
|------|----------|----------|
| 2.3 | 2026-02-23 | 架构重构，统一发现抽象，代码规范 |
| 0.8.0 | 2026-02-20 | 能力发现服务抽象 |
| 0.7.3 | 2026-02-17 | 节点发现、本地认证、离线支持 |
| 0.7.0 | 2026-02-10 | 初始版本 |
