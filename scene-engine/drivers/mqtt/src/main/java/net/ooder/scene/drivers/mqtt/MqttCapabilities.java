...
public class MqttCapabilities {
    ...
    public boolean isSupportBroker() { return supportBroker; }
    public void setSupportBroker(boolean supportBroker) { this.supportBroker = supportBroker; }
    public boolean isSupportPublish() { return supportPublish; }
    public void setSupportPublish(boolean supportPublish) { this.supportPublish = supportPublish; }
    public boolean isSupportSubscribe() { return supportSubscribe; }
    public void setSupportSubscribe(boolean supportSubscribe) { this.supportSubscribe = supportSubscribe; }
    ...
    public boolean isSupportCommand() { return supportCommand; }
    public void setSupportCommand(boolean supportCommand) { this.supportCommand = supportCommand; }
    ...
    public boolean isSupportQos0() { return supportQos0; }
    public void setSupportQos0(boolean supportQos0) { this.supportQos0 = supportQos0; }
    public boolean isSupportQos1() { return supportQos1; }
    public void setSupportQos1(boolean supportQos1) { this.supportQos1 = supportQos1; }
    public boolean isSupportQos2() { return supportQos2; }
    public void setSupportQos2(boolean supportQos2) { this.supportQos2 = supportQos2; }
    public boolean isSupportRetained() { return supportRetained; }
    public void setSupportRetained(boolean supportRetained) { this.supportRetained = supportRetained; }
    public boolean isSupportWill() { return supportWill; }
    public void setSupportWill(boolean supportWill) { this.supportWill = supportWill; }
    public boolean isSupportTls() { return supportTls; }
    public void setSupportTls(boolean supportTls) { this.supportTls = supportTls; }
    public boolean isSupportAuth() { return supportAuth; }
    public void setSupportAuth(boolean supportAuth) { this.supportAuth = supportAuth; }
    public boolean isSupportCluster() { return supportCluster; }
    public void setSupportCluster(boolean supportCluster) { this.supportCluster = supportCluster; }
    public boolean isSupportBridge() { return supportBridge; }
    public void setSupportBridge(boolean supportBridge) { this.supportBridge = supportBridge; }
    public boolean isSupportRuleEngine() { return supportRuleEngine; }
    public void setSupportRuleEngine(boolean supportRuleEngine) { this.supportRuleEngine = supportRuleEngine; }
