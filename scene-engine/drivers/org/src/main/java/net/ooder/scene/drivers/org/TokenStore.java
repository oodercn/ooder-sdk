...
public class TokenStore {
    ...
    private final Map<String, TokenInfo> tokenMap = new ConcurrentHashMap<String, TokenInfo>();
    private final Map<String, String> refreshTokenMap = new ConcurrentHashMap<String, String>();
