...
public class JsonOrg implements Org {
    ...
    private transient net.ooder.scene.skills.org.JsonOrgDataSource dataSource;
    ...
    public void setDataSource(net.ooder.scene.skills.org.JsonOrgDataSource dataSource) {
