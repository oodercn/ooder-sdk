...
public interface SceneInterfaceManager {
    ...
    CompletableFuture<InterfaceResolver.ResolvedInterface> resolveInterface(String sceneId, String interfaceId);
    
    CompletableFuture<List<InterfaceResolver.ResolvedInterface>> resolveAllInterfaces(String sceneId);
