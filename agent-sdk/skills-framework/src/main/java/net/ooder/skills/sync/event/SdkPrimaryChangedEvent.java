...
public class SdkPrimaryChangedEvent extends SdkEvent {
    
    private String groupId;
    private String oldPrimaryId;
    private String newPrimaryId;
    
    public SdkPrimaryChangedEvent() {
        super();
    }
    
    public SdkPrimaryChangedEvent(String groupId, String oldPrimaryId, String newPrimaryId) {
