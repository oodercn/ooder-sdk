...
├── ood.UI.Div          → 简单容器组件（Card、TreeGrid）
...
#### TreeGrid 网格组件
```javascript
var grid = new ood.Mobile.TreeGrid({
    columns: 2,          // 列数
    gap: '16px',         // 间距
    responsive: true,    // 响应式
    items: gridItems
...
# CDN 引入
<script src="https://cdn.ood.com/mobile/1.0.0/ood-mobile.min.js"></script>
<link href="https://cdn.ood.com/mobile/1.0.0/ood-mobile.min.css" rel="stylesheet">
