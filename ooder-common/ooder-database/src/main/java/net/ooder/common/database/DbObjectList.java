/**
 * $RCSfile: DbObjectList.java,v $
 * $Revision: 1.1 $
 * $Date: 2017/03/11 04:04:29 $
 *
...
public abstract class DbObjectList<T> extends AbstractList implements Cloneable,
		Serializable {
	...
	public Object clone() {
		try {
			DbObjectList v = (DbObjectList) super.clone();
