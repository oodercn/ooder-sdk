...
public enum CustomTreeGridAction implements ActionType, CustomAction, Enumstype {
    ...
    CustomTreeGridAction(String script, String[] params) {
        this.script = script;
        this.params = params;
    }

    CustomTreeGridAction(String desc, String expression, Boolean _return) {
        this.desc = desc;
