...
public enum CardPreset {
    ...
    public CSFont getFont() {
        return new CSFont() {
            ...
            @Override
            public String color() { return "#333333"; }

            @Override
            public String fontSize() { return "14px"; }
    ...
    public CSLayout getLayout() {
        return new CSLayout() {
            ...
            @Override
            public String padding() { return "16px"; }
    ...
    public CSBorder getBorder() {
        return new CSBorder() {
            ...
            @Override
            public String borderRadius() { return "8px"; }
            ...
            public String boxShadow() {
                switch (CardPreset.this) {
                    case SHADOW: return "0 2px 8px rgba(0, 0, 0, 0.1)";
                    default: return "";
                }
            }
