// UI组件国际化资源
(ood.Locale.cn || (ood.Locale.cn = {})).UI = {
    // ButtonLayout组件
    buttonlayout: {
        label: "按钮布局",
        button: "按钮",
...
(ood.Locale.cn || (ood.Locale.cn = {})).RAD = {
    message: "开发一次，到处运行！",
    ...
    msg: {
        ...
        'Package $0 doest exist': 'OOD 模板文件的发布包 $0 不存在！',
        'File $0 is not a ood template': '$0 不是有效的 OOD 模板文件发布包！',
    ...
    ws: {
        ...
        "ESDUI stores your projects in a  folder, called OODWorkspace. Choose a folder to move/switch your OODWorkspace to": "工作空间是ESDUI存储工程的一个本地文件夹。您可以将工作空间移动或切换到以下选定文件夹",
        "Select target folder": "请选择",
        Move: "移动工作空间到",
        Switch: "切换工作空间到",
        "Target Folder": "目标文件夹",
        "Switch OOD Workspace to following target folder, move all project files into it, and remove the old OOD Workspace folder": "将工作空间切换到目标文件夹，并且移动目前工作空间中的所有工程。",
        "Switch OOD Workspace to following target folder only, don't move any project files, don't remove the old OOD Workspace": "仅将工作空间切换到目标文件夹，不移动目前工作空间中的工程。",
        "Your OODWorkSpace has been $0 to '$1' successfully": "工作空间已经顺利转换到‘$1’"
    },
...
//        "Online Modules":'从远程模块模板库',
    ...
    action: {
        ...
        "Selected Node": "选定子项",
        "Var Path is": "变量路径",
        "OOD Variable Expression Tool": "OOD 变量表达式构造工具",
        "OOD Function Expression Tool": "OOD 函数表达式构造工具",
        "Current Page": "当前页面",
        ...
        "var": {
            ...
            "Event": "DOM事件",
            "ood.Dom": "ood的Dom对象",
            "ood.Profile": "ood类的配置对象",
            "ood.UIProfile": "ood控件的配置对象",
            "ood.UI": "ood控件对象",
    ...
    phonegap: {
        "OOD PhoneGap Builder": "OOD 手持应用App构建器",
    ...
    fc: {
        ...
        cats: {
            ...
            'Divisional Lines/TreeGrids': '分割线与网格',
            'Quadrants': '象限',
        ...
        keys: {
            ...
            showAlternateHTreeGridColor: '交替显示水平网格色',
            alternateHTreeGridColor: '水平网格交替色',
            alternateHTreeGridAlpha: '水平网格交替透明度',
            showAlternateVTreeGridColor: '垂直网格交替色',
            alternateVTreeGridColor: '交替显示垂直网格色',
            alternateVTreeGridAlpha: '垂直网格交替透明度',
...
(function () {
    ood.set(ood.Locale.cn, ["RAD", "FormLayout"], {
...
(function () {
    ood.set(ood.Locale, ["cn", "doc", "propname"], {
        'ood_absObj': {
            tag: '附加值',
            tagVar: '附加对象',
            dataBinder: '数据绑定器',
    ...
    ood.set(ood.Locale, ["cn", "doc", "eventname"], {
        'ood_Module': {
            beforeCreated: "部件生成前",
        ...
        'ood_UI_TreeGrid': {
            ...
            beforeTreeGridValueCalculated: "表格值计算后",
            afterTreeGridValueCalculated: "表格值计算后",
            onGetExcelCellValue: '得到Excel单元格值'
        },
        'ood_UI_TagEditor': {},
        'ood_UI_Range': {},
    ...
    // DataModel Captions 国际化
    (ood.Locale.cn || (ood.Locale.cn = {})).DataModel = {
    "": "",
    ...
    ButtonLayout: {
        ...
        autoColumns: "自动列数",
        expression: "表达式",
        autoFontColor: "自动字体颜色",
        autoIconColor: "自动图标颜色",
        autoItemColor: "自动项目颜色",
        autoImgSize: "自动图片大小",
        autoItemSize: "自动项目大小",
        iconOnly: "仅显示图标",
        itemMargin: "项目边距",
        ...
        Label: {
            theme: { caption: "主题" },
            responsive: { caption: "响应式" },
            selectable: { caption: "可选择" },
            expression: { caption: "表达式" },
            caption: { caption: "标题" },
            clock: { caption: "时钟" },
            image: { caption: "图像" },
            imagePos: { caption: "图像位置" },
            imageBgSize: { caption: "图像背景大小" },
            imageClass: { caption: "图像类" },
            iconFontCode: { caption: "图标字体代码" },
            iconFontColor: { caption: "图标字体颜色" },
            hAlign: { caption: "水平对齐" },
            vAlign: { caption: "垂直对齐" },
            fontColor: { caption: "字体颜色" },
            fontSize: { caption: "字体大小" },
            fontWeight: { caption: "字体粗细" },
            fontFamily: { caption: "字体" },
            excelCellFormula: { caption: "Excel单元格公式" }
        },
        ...
        TreeGrid: {
            expression: { caption: "表达式" },
            directInput: { caption: "直接输入" },
            currencyTemplate: { caption: "货币模板" },
            numberTemplate: { caption: "数字模板" },
            valueSeparator: { caption: "值分隔符" },
            selMode: { caption: "选择模式" },
            editMode: { caption: "编辑模式" },
            dock: { caption: "停靠方式" },
            togglePlaceholder: { caption: "切换占位符" },
            alternateRowBg: { caption: "交替行背景" },
            rowNumber: { caption: "行编号" },
            editable: { caption: "可编辑" },
            firstCellEditable: { caption: "首单元格可编辑" },
            indent: { caption: "子节点缩进" },
            initiallyCollapsed: { caption: "初始折叠" },
            collapseAnimation: { caption: "折叠动画" },
            position: { caption: "定位方式" },
            width: { caption: "宽度" },
            height: { caption: "高度" },
            minColWidth: { caption: "最小列宽" },
            maxColWidth: { caption: "最大列宽" },
            minRowHeight: { caption: "最小行高" },
            gridCaption: { caption: "网格标题" },
            headTail: { caption: "头部尾部" },
            rowHandlerWidth: { caption: "行处理器宽度" },
            showHeader: { caption: "显示头部" },
            headerHeight: { caption: "头部高度" },
            rowHeight: { caption: "行高度" },
            defaultColWidth: { caption: "默认列宽" },
            rowHandler: { caption: "行处理器" },
            rowResizer: { caption: "行调整器" },
            colHidable: { caption: "列可隐藏" },
            colResizer: { caption: "列调整器" },
            colSortable: { caption: "列可排序" },
            colMovable: { caption: "列可移动" },
            header: { caption: "头部" },
            uidCol: { caption: "UID列" },
            groupCol: { caption: "分组列" },
            rowData: { caption: "行数据" },
            rawData: { caption: "原始数据" },
            dataSet: { caption: "数据集" },
            tagCmds: { caption: "标签命令" },
            activeMode: { caption: "激活模式" },
            rowOptions: { caption: "行选项" },
            colOptions: { caption: "列选项" },
            treeMode: { caption: "树模式" },
            frozenCols: { caption: "冻结列数" },
            frozenRows: { caption: "冻结行数" },
            hotRowMode: { caption: "热行模式" },
            excelCellId: { caption: "Excel单元格ID" },
            gridValueFormula: { caption: "网格值公式" },
            hotRowNumber: { caption: "热行编号" },
            hotRowCellId: { caption: "热行单元格标识" },
            hotRowRequired: { caption: "热行必填" },
            noCtrlKey: { caption: "无需Ctrl键" }
        },

        // Tabs 组件
        Tabs: {
            autoFontColor: { caption: "自动字体颜色" },
            autoIconColor: { caption: "自动图标颜色" },
            autoItemColor: { caption: "自动项颜色" },
            expression: { caption: "表达式" },
            selectable: { caption: "可选择" },
            dirtyMark: { caption: "脏标记" },
            lazyAppend: { caption: "延迟追加" },
            isFormField: { caption: "表单字段" },
            dock: { caption: "停靠方式" },
            width: { caption: "宽度" },
            height: { caption: "高度" },
            position: { caption: "位置" },
            itemWidth: { caption: "项宽度" },
            itemAlign: { caption: "项对齐" },
            HAlign: { caption: "水平对齐" },
            dropKeysPanel: { caption: "面板拖放键" },
            value: { caption: "值" },
            selMode: { caption: "选择模式" },
            noPanel: { caption: "无面板" },
            noHandler: { caption: "无句柄" },
            tagCmds: { caption: "标签命令" }
        },

        // Resizer 组件
        Resizer: {
            forceVisible: { caption: "强制可见" },
            forceMovable: { caption: "强制可移动" },
            singleDirection: { caption: "单方向" },
            verticalResize: { caption: "垂直调整" },
            horizontalResize: { caption: "水平调整" },
            minHeight: { caption: "最小高度" },
            minWidth: { caption: "最小宽度" },
            maxHeight: { caption: "最大高度" },
            maxWidth: { caption: "最大宽度" },
            handlerSize: { caption: "操作柄大小" },
            handlerOffset: { caption: "操作柄偏移" },
            readonly: { caption: "只读" },
            disabled: { caption: "禁用" },
            leftConfigButton: { caption: "左侧配置按钮" },
            rightConfigButton: { caption: "右侧配置按钮" },
            rotatable: { caption: "可旋转" },
            left: { caption: "左侧位置" },
            top: { caption: "顶部位置" },
            height: { caption: "高度" }
        },
        ...
        ContentBlock: {
            ...
            autoFontColor: { caption: "自动字体颜色" },
            autoIconColor: { caption: "自动图标颜色" },
            autoItemColor: { caption: "自动项目颜色" },
            autoImageSize: { caption: "自动图片大小" },
            autoItemSize: { caption: "自动项目大小" },
            iconFontSize: { caption: "图标字体大小" },
            itemSpacing: { caption: "项目间距" },
            itemPadding: { caption: "项目内边距" },
            itemWidth: { caption: "项目宽度" },
            itemHeight: { caption: "项目高度" },
            width: { caption: "宽度" },
            height: { caption: "高度" },
            columns: { caption: "列数" },
            rows: { caption: "行数" }
        ...
        // Input 组件
        Input: {
            selectable: { caption: "可选" },
            expression: { caption: "表达式" },
            errorTip: { caption: "错误提示" },
            successTip: { caption: "成功提示" },
            dynamicCheck: { caption: "动态检查" },
            selectOnFocus: { caption: "获得焦点时选中" },
            placeholder: { caption: "占位文本" },
            labelSize: { caption: "标签大小" },
            labelPosition: { caption: "标签位置" },
            labelSpacing: { caption: "标签间距" },
            labelCaption: { caption: "标签标题" },
            labelHAlign: { caption: "标签水平对齐" },
            labelVAlign: { caption: "标签垂直对齐" },
            width: { caption: "宽度" },
            height: { caption: "高度" },
            hAlign: { caption: "水平对齐" },
            disabled: { caption: "禁用状态" },
            hideBorder: { caption: "隐藏边框" },
            readonly: { caption: "只读" },
            textType: { caption: "文本类型" },
            maxLength: { caption: "最大长度" },
            multiline: { caption: "多行文本" },
            autoExpand: { caption: "自动扩展" },
            tipBinding: { caption: "提示绑定" },
            excelCellId: { caption: "Excel单元格ID" },
            excelFormula: { caption: "Excel公式" }
        },

        // Panel 组件
        Panel: {
            theme: { caption: "主题" },
            responsive: { caption: "响应式设计" },
            selectable: { caption: "可选" },
            dock: { caption: "停靠方式" },
            caption: { caption: "标题" },
            html: { caption: "HTML内容" },
            ...
            imagePos: { caption: "图像位置" },
            imageBgSize: { caption: "图像背景大小" },
            imageClass: { caption: "图像类名" },
            iconFontCode: { caption: "图标字体代码" },
            borderType: { caption: "边框类型" },
            noFrame: { caption: "无框架" },
            hAlign: { caption: "水平对齐" },
            toggleIcon: { caption: "切换图标" },
            infoButton: { caption: "信息按钮" },
            optionsButton: { caption: "选项按钮" },
            toggleButton: { caption: "切换按钮" },
            closeButton: { caption: "关闭按钮" },
            refreshButton: { caption: "刷新按钮" },
            popButton: { caption: "弹出按钮" },
            tagCmds: { caption: "标签命令" }
        }
    };
    ood.Locale.cn.DataModel={
        theme: "主题",
        responsive: "响应式",
        autoColumns: "自动列数",
        tagCommands: "标签命令",
        ...
        autoexpand: "自动扩展",
        tipsBinder: "提示绑定",
        excelCellId: "Excel单元格ID",
        excelCellFormula: "Excel公式",
        mode: "模式",
        rowGap: "行间距",
        solidTreeGrid: "实线网格",
        stretchHeight: "拉伸高度",
