...
ood.Class("ood.UI.TreeGrid", ["ood.UI", "ood.absValue"], {
    Instance: {
        ...
        iniProp: {
            ...
            header: [
                ...
                {caption: '名称', id: 'name', width: 120},
                {caption: '状态', id: 'status', width: 80},
                {caption: '创建时间', id: 'createTime', width: 140}
            ],
            rows: [
                {
                    id: '1',
                    cells: [{value: '1'}, {value: '测试数据1'}, {value: '启用'}, {value: '2024-01-01'}]
                },
                {
                    id: '2',
                    cells: [{value: '2'}, {value: '测试数据2'}, {value: '禁用'}, {value: '2024-01-02'}]
                },
                {
                    id: '3',
                    cells: [{value: '3'}, {value: '测试数据3'}, {value: '启用'}, {value: '2024-01-03'}]
                }
            ]
        },
        ...
        calculateTreeGridValue: function () {
            ...
            if (profile.beforeTreeGridValueCalculated && false !== (v2 = profile.boxing().beforeTreeGridValueCalculated(profile))) {
                value = v2;
            } else {
                if (f) {
            ...
            if (profile.afterTreeGridValueCalculated)
                profile.boxing().afterTreeGridValueCalculated(profile, value);
        ...
        getExcelCellValue: function () {
            ...
            if (prop.excelCellId) {
                value = ('_$gridvalue' in profile) ? profile._$gridvalue : this.caculateTreeGridValue();
        ...
        triggerFormulas: function (cellFrom, dirtyMark, triggerEvent) {
            return this.each(function (prf) {
                ...
                if (prop.gridValueFormula) {
                    prf.boxing().calculateTreeGridValue(false);
                }
            });
        },
        /*insert rows to dom
        ...
        */
        ...
        getSubNodeInTreeGrid: function (key, rowId, colId) {
            var ns = this,
    ...
    Static: {
        ...
        Behaviors: {
            ...
            HCELLA: {
                onClick: function (profile, e, src) {
                    ...
                    if (!col) {
                        if (profile.onClickTreeGridHandler)
                            profile.boxing().onClickTreeGridHandler(profile, e, src);
        ...
        DataModel: {
            ...
            directInput: {
                ini: true,
                caption: ood.getResText("DataModel.directInput") || "直接输入"
            },
            listKey: null,
            currencyTpl: {
                ini: "$ *",
            ...
            valueSeparator: {
                ini: ";",
                caption: ood.getResText("DataModel.valueSeparator") || "值分隔符"
            },
            activeRow: {
                hidden: true,
                ini: null
            ...
            editMode: {
                ini: 'focus',
                caption: ood.getResText("DataModel.editMode") || "编辑模式",
                listbox: ["focus", "sharp", "hover", "hoversharp", "inline"]
            },
            dock: {
                ini: 'fill',
                caption: ood.getResText("DataModel.dock") || "停靠方式"
            },
            togglePlaceholder: {
                ini: false,
                caption: ood.getResText("DataModel.togglePlaceholder") || "切换占位符"
            ...
            altRowsBg: {
                ini: false,
                caption: ood.getResText("DataModel.alternateRowBg") || "交替行背景",
                action: function (value) {
                    var ns = this;
            ...
            rowNumbered: {
                ini: false,
                caption: ood.getResText("DataModel.rowNumbering") || "行编号",
                action: function (value) {
                    var ns = this,
...
//                            }
            ...
            editable: {
                ini: false,
                caption: ood.getResText("DataModel.editable") || "可编辑"
            },
            firstCellEditable: {
                ini: false,
                caption: ood.getResText("DataModel.firstCellEditable") || "首单元格可编辑"
            },

            $subMargin: {
                ini: '1.375em',
                caption: ood.getResText("DataModel.childIndent") || "子节点缩进"
            },

            iniFold: {
                ini: true,
                caption: ood.getResText("DataModel.initialCollapse") || "初始折叠"
            },

            animCollapse: {
                ini: false,
                caption: ood.getResText("DataModel.collapseAnimation") || "折叠动画"
            },

            position: {
                ini: 'absolute',
                caption: ood.getResText("DataModel.position") || "定位方式"
            },
            width: {
                ini: '25em',
            ...
            _minColW: {
                ini: '.5em',
                caption: ood.getResText("DataModel.minColW") || "最小列宽"
            },
            _maxColW: {
                ini: '25em',
                caption: ood.getResText("DataModel.maxColW") || "最大列宽"
            },
            _minRowH: {
                ini: '1.83333em',
                caption: ood.getResText("DataModel.minRowH") || "最小行高"
            },

            gridHandlerCaption: {
                ini: "",
                caption: ood.getResText("DataModel.gridHandlerCaption") || "网格标题",
                action: function (v) {
                    v = (ood.isSet(v) ? v : "") + "";
            ...
            headerTail: {
                ini: "",
                caption: ood.getResText("DataModel.headerTail") || "头部尾部",
                action: function (v) {
                    v = (ood.isSet(v) ? v : "") + "";
            ...
            rowHandlerWidth: {
                $spaceunit: 1,
                ini: '5em',
                caption: ood.getResText("DataModel.rowHandlerWidth") || "行处理器宽度",
                set: function (value) {
                    var o = this;
                    if (o.renderId)
            ...
            showHeader: {
                ini: true,
                caption: ood.getResText("DataModel.showHeader") || "显示头部",
                action: function (value) {
            ...
            headerHeight: {
                $spaceunit: 1,
                ini: '2em',
                caption: ood.getResText("DataModel.headerHeight") || "头部高度",
                action: function (v) {
                    var profile = this,
                        prop = profile.properties;
                    profile.box._adjustColsHeight(profile);
            ...
            rowHeight: {
                $spaceunit: 1,
                ini: '2em',
                caption: ood.getResText("DataModel.rowHeight") || "行高度",
                action: function (v) {
            ...
            _colDfWidth: {
                ini: '8em',
                caption: ood.getResText("DataModel.colDfWidth") || "默认列宽"
            },


            rowHandler: {
                ini: true,
                caption: ood.getResText("DataModel.rowHandler") || "行处理器",
                action: function (value) {
            ...
            rowResizer: {
                ini: false,
                caption: ood.getResText("DataModel.rowResizer") || "行调整器",
                action: function (value) {
            ...
            colHidable: {
                ini: false,
                caption: ood.getResText("DataModel.colHidable") || "列可隐藏"
            },
            colResizer: {
                ini: true,
                caption: ood.getResText("DataModel.colResizer") || "列调整器",
                action: function (value) {
            ...
            colSortable: {
                ini: true,
                caption: ood.getResText("DataModel.colSortable") || "列可排序",
                action: function (value) {
                    if (!value)
            ...
            colMovable: {
                ini: false,
                caption: ood.getResText("DataModel.colMovable") || "列可移动"
            },

            header: {
                ini: {},
                caption: ood.getResText("DataModel.header") || "头部",
                set: function (value) {
                    var o = this;
                    if (o.renderId) {
            ...
            uidColumn: {
                ini: '',
                caption: ood.getResText("DataModel.uidColumn") || "UID列",
            },
            grpCols: {
                //for default merge
                ini: {},
                caption: ood.getResText("DataModel.grpCols") || "分组列",
                set: function (value) {
                    var o = this;
            ...
            rows: {
                //for default merge
                ini: {},
                caption: ood.getResText("DataModel.rows") || "行数据",
                set: function (value) {
                    var o = this;
                    if (o.renderId)
            ...
            rawData: {
                ini: [],
                caption: ood.getResText("DataModel.rawData") || "原始数据",
                set: function (value) {
            ...
            dataset: {
                ini: {},
                caption: ood.getResText("DataModel.dataset") || "数据集",
                get: function () {
                ...
                set: function (v) {
                    ...
                    if (ins.beforeApplyDataset && false === ins.beforeApplyDataset(prf, dataset)) {
                        ...
                        if ('name' in dataset) ins.setTreeGridHandlerCaption(dataset.name);
            ...
            activeMode: {
                ini: 'row',
                caption: ood.getResText("DataModel.activeMode") || "激活模式",
            ...
            rowOptions: {
                ini: {},
                caption: ood.getResText("DataModel.rowOptions") || "行选项",
                action: function (value) {
                    var ins = this.boxing(),
            ...
            colOptions: {
                ini: {},
                caption: ood.getResText("DataModel.colOptions") || "列选项",
                action: function (value) {
                    var ins = this.boxing(),
                        rows = ins.getRows('data');
                    ins.removeAllRows();
            ...
            treeMode: {
                ini: 'inhandler',
                caption: ood.getResText("DataModel.treeMode") || "树模式",
            ...
            freezedColumn: {
                ini: 0,
                caption: ood.getResText("DataModel.frozenCols") || "冻结列数",
                action: function () {
                    this.boxing().refresh();
                    this.box._adjustColsWidth(this);
                }
            ...
            freezedRow: {
                ini: 0,
                caption: ood.getResText("DataModel.frozenRows") || "冻结行数",
                action: function () {
                    this.boxing().refresh();
                }
            },
            hotRowMode: {
                ini: 'none',
                caption: ood.getResText("DataModel.hotRowMode") || "热行模式",
            ...
            gridValueFormula: {
                ini: "",
                caption: ood.getResText("DataModel.gridValueFormula") || "网格值公式"
            },
            hotRowNumber: {
                ini: '[*]',
                caption: ood.getResText("DataModel.hotRowNumber") || "热行编号"
            },
            hotRowCellCap: {
                ini: '(*)',
                caption: ood.getResText("DataModel.hotRowCellId") || "热行单元格标识"
            },
            hotRowRequired: {
                ini: '',
                caption: ood.getResText("DataModel.hotRowRequired") || "热行必填"
            },
            noCtrlKey: {
                ini: true,
        ...
        EventHandlers: {
            ...
            beforeHotRowAdded: function (profile, cellMap, row, leaveTreeGrid) {
            },
            ...
            onClickTreeGridHandler: function (profile, e, src) {
            },
            ...
            // beforeApplyTreeGridExcelFormula
            // afterApplyTreeGridExcelFormula
            beforeApplyFormula: function (profile, cell, value, formula) {
            },
            afterApplyFormulas: function (profile, dataArrs) {
            },
            beforeTreeGridValueCalculated: function (profile) {
            },
            afterTreeGridValueCalculated: function (profile, value) {
            },
        ...
        RenderTrigger: function () {
            ...
            if (prop.excelCellId)
                ns.boxing().calculateTreeGridValue();
        },
