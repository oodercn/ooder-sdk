                        ...
                        case 'other':
                            switch (target) {
                                ...
                                case 'msg':
                                    ...
                                    } else if (method == "console" && ood.isDefined(window.console) && (typeof console.log == "function")) console.log.apply(console, iparams);
                                    else if (ood.isFun(t = ood.get(ood, [method]))) t.apply(ood, iparams);
                                    break;
                                case "var":
                                    if (iparams[0].length) {
                                        var v = iparams[1];
