ood.Class("ood.UI.FoldingList", ["ood.UI.List"],{
    ...
    Static:{
        ...
        _onresize:function(){
            if (this.properties.responsive !== false) {
                this.boxing().adjustLayout();
            }
        },
        ...
        adjustLayout: function() {
            return this.each(function(profile) {
                ...
                // 对于小屏幕，调整布局
                if (width < 768) {
                    root.addClass('foldinglist-mobile');
                } else {
                    root.removeClass('foldinglist-mobile');
                }

                // 超小屏幕特殊处理
                if (width < 480) {
                    root.addClass('foldinglist-tiny');
                } else {
                    root.removeClass('foldinglist-tiny');
                }
            });
        },
