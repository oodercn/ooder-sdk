...
@JDocumentType(name = "CommandIndex",vfsJson = @VFSJsonType(vfsPath = "iot/command/",fileName = "commandLog.js"), fsDirectory = @FSDirectoryType(id = "fsCommandIndex") , indexWriter = @JIndexWriterType(id = "iwCommandIndex") )
public class CommandIndex implements JLuceneIndex,CommandMsg {
    ...
    @JFieldType(store = Store.YES)
    private CommandEventEnums resultCode;
