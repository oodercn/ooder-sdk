...
@JDocumentType(name = "IOTEventIndex", fsDirectory = @FSDirectoryType(id = "fsLogIndex") , vfsJson = @VFSJsonType(vfsPath = "iot/event/",fileName = "eventLog.js"), indexWriter = @JIndexWriterType(id = "iwEventIndex") )
public class EventIndex implements JLuceneIndex,LogMsg {
    ...
    public EventIndex(LogMsg msg ){
        ...
        this.path=msg.getReceiver()==null?msg.getFrom():msg.getFrom();
