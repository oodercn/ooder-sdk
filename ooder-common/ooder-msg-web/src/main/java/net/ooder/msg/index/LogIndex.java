...
@JDocumentType(name = "LogIndex", fsDirectory = @FSDirectoryType(id = "fsLogIndex") , vfsJson = @VFSJsonType(vfsPath = "iot/log/",fileName = "dataLog.js"), indexWriter = @JIndexWriterType(id = "iwLogIndex") )
public class LogIndex implements JLuceneIndex,LogMsg {
