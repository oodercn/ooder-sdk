...
public class HomeException extends JDSException {
    ...
    public static final int USERNAMEALREADYEXITS = 1001;// 1001: userName already exits(用户已存在)

    public static final int USERNAMENOTSTANDARD = 1002;// userName Not standard (用户不规范)

    public static final int USERNAMEONTEXITS = 1003;// 1003: userName is not exits (用户不存在)
    ...
    public static final int MOBILENOTSTANDARD = 2001;// Mobile phone number is not standard(手机号码不规范)

    public static final int MOBILEALERADYEXITS = 2002;// Mobile phone already exits (手机号码已存在)
    ...
    public static final int MAILNOTSTANDARD = 4001;// 4001 mail is not standard(邮箱号码不规范)

    public static final int MAILALERADYEXITS = 4002;// mail already exits (邮箱号码已存在)
    ...
    public static final int SENSOROFFINE = 7007;// 传感器离线
    ...
    public static final int DEVICENOEXITS = 9001;// 设备不存在
     ...
     * @param errorCode
     *            Error code defined in BILL.
     */
    public HomeException(String message, int errorCode) {
	super(message);
     ...
     *            Error code defined in BILL.
     */
    public HomeException(String message, Throwable cause, int errorCode) {
	this(message, cause);
	this.errorCode = errorCode;
    }
