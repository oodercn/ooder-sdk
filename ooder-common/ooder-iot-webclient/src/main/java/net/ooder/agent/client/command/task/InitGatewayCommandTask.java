...
public class InitGatewayCommandTask implements Callable<Command> {
	private MinServerActionContextImpl autoruncontext;
	private ConfigCode configCode;
	private String gatewayieee;


	public InitGatewayCommandTask(String gatewayieee,String systemCode) {
	...
	public Command call() throws Exception {
		...
		return commandClient.sendInitGatewayCommand().get();
	}
