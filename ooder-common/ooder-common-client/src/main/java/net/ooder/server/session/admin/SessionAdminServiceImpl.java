...
public class SessionAdminServiceImpl implements SessionAdminService {
    ...
    private static final Log log = LogFactory.getLog(OrgConstants.CONFIG_KEY.getType(), SessionAdminServiceImpl.class);
    ...
    public SessionAdminServiceImpl(SessionCacheManager cacheManager, SessionManager sessionManager, long expireTime) {
    ...
    public SessionOperationResult invalidateSessionsByUserId(String userId) {
        ...
        try {
            ...
            log.error("Failed to invalidate sessions by userId: " + e.getMessage());
    ...
    public SessionOperationResult invalidateSessionsByAccount(String account) {
        ...
        try {
            ...
            log.info("Invalidated " + count + " sessions for account: " + account);
            return SessionOperationResult.success("INVALIDATE_BY_ACCOUNT", account, 
                "Invalidated " + count + " sessions");
        } catch (Exception e) {
            log.error("Failed to invalidate sessions by account: " + e.getMessage());
    ...
    public SessionOperationResult invalidateAllSessions() {
        try {
            ...
            log.info("Invalidated all " + count + " sessions");
            return SessionOperationResult.success("INVALIDATE_ALL", null, 
                "Invalidated " + count + " sessions");
        } catch (Exception e) {
            log.error("Failed to invalidate all sessions: " + e.getMessage());
    ...
    public SessionOperationResult invalidateExpiredSessions() {
        try {
            ...
            log.info("Invalidated " + count + " expired sessions");
            return SessionOperationResult.success("INVALIDATE_EXPIRED", null, 
                "Invalidated " + count + " expired sessions");
        } catch (Exception e) {
            log.error("Failed to invalidate expired sessions: " + e.getMessage());
    ...
    public SessionOperationResult keepAlive(String sessionId) {
        ...
        try {
            ...
            log.error("Failed to keep-alive session: " + e.getMessage());
    ...
    public SessionOperationResult forceLogout(String sessionId, String reason) {
        ...
        try {
            ...
            log.info("Session force logout: " + sessionId + ", reason: " + reason);
            return SessionOperationResult.success("FORCE_LOGOUT", sessionId, 
                "Force logout successful. Reason: " + reason);
        } catch (Exception e) {
            log.error("Failed to force logout session: " + e.getMessage());
