 ...
 */
/**
 * $RCSfile: JDSBasicConverter.java,v $
 * $Revision: 1.0 $
 * $Date: 2025/08/25 $
 * <p>
...
public class JDSBasicConverter extends DefaultTypeConverter {
    ...
    public Object convertValue(Map context, Object o, Member member, String s, Object value, Class toType) {
        ...
        if (result == null) {
            ...
            if (result == null && value != null && !"".equals(value)) {
                try {
                    throw new OgnlException("Cannot create type " + toType + " from value " + value);
...
//        }
        ...
        if (toType == Set.class) {
            ...
            if (size > 0) {
                result = new JDSList(memberType, size);
            } else {
                result = new JDSList(memberType);
            }
        }
    ...
    private Class doConvertToClass(Object value) {
        ...
        if (value instanceof String && value != null && ((String) value).length() > 0) {
            try {
                ...
                try {
                    throw new OgnlException(e.getLocalizedMessage(), e);
    ...
    private Collection doConvertToCollection(Map context, Object o, Member member, String prop, Object value, Class toType) {
        ...
        if (o != null) {
            ...
            memberType = JDSConverter.getInstance().getObjectTypeDeterminer().getElementClass(o.getClass(), prop, null);
            ...
            try {
                ...
                if (!(Date.class == toType)) {
                    try {
                        ...
                        try {
                            throw new OgnlException("Couldn't create class " + toType + " using default (long) constructor", e);
                        } catch (OgnlException e1) {
                            // TODO Auto-generated catch block
                            e1.printStackTrace();
                        }
                ...
                try {
                    throw new OgnlException("Could not parse date", e);
                } catch (OgnlException e1) {
                    // TODO Auto-generated catch block
                    e1.printStackTrace();
                }
        ...
        if (value instanceof String) {
            if (toType == BigDecimal.class) {
                ...
                if (parsePos.getIndex() != stringValue.length()) {
                    try {
                        throw new OgnlException("Unparseable number: \"" + stringValue + "\" at position "
                                + parsePos.getIndex());
                    } catch (OgnlException e) {
                        // TODO Auto-generated catch block
                        e.printStackTrace();
