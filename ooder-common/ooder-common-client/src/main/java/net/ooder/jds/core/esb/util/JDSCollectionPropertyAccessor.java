...
/**
 * $RCSfile: JDSCollectionPropertyAccessor.java,v $
 * $Revision: 1.0 $
 * $Date: 2025/08/25 $
 * <p>
 ...
 * @author Gabe
 */
public class JDSCollectionPropertyAccessor extends SetPropertyAccessor {

    private static final Log LOG = LogFactory.getLog(JDSCollectionPropertyAccessor.class);
    private static final String CONTEXT_COLLECTION_MAP = "JDSCollectionPropertyAccessorContextSetMap";
     ...
     * the input.
     *
     * @see ognl.PropertyAccessor#getProperty(Map, Object, Object)
     */
    public Object getProperty(Map context, Object target, Object key)
        ...
        ObjectTypeDeterminer objTypeDeterminer=JDSConverter.getInstance()
        ...
        Class collClass = JDSConverter.getInstance()
        ...
        if (OgnlContextState.isCreatingNullObjects(context)) {
            ...
            Object realKey = JDSConverter.getInstance().convertValue(context, key, keyType);
