...
public interface ValueStack {
    ...
    public static final String VALUE_STACK = "net.ooder.jds.core.esb.util.ValueStack.ValueStack";

    public static final String REPORT_ERRORS_ON_NO_PROP = "net.ooder.jds.core.esb.util.ValueStack.ReportErrorsOnNoProp";
