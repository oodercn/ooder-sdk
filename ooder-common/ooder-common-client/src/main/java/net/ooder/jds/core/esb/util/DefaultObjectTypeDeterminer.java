 ...
 */
/**
 * $RCSfile: DefaultObjectTypeDeterminer.java,v $
 * $Revision: 1.0 $
 * $Date: 2025/08/25 $
 * <p>
...
public class DefaultObjectTypeDeterminer implements ObjectTypeDeterminer {
     ...
     * @see net.ooder.jds.core.esb.util.ObjectTypeDeterminer#getKeyClass(Class, String)
     */
    public Class getKeyClass(Class parentClass, String property) {
        ...
        return (Class) JDSConverter.getInstance().getConverter(parentClass, KEY_PREFIX + property);
    }
     ...
     * @param parentClass the Class which contains as a property the Map or Collection we are finding the key for.
     * @param property    the property of the Map or Collection for the given parent class
     * @see net.ooder.jds.core.esb.util.ObjectTypeDeterminer#getElementClass(Class, String, Object)
     */
    public Class getElementClass(Class parentClass, String property, Object key) {
        ...
        clazz = (Class) JDSConverter.getInstance().getConverter(parentClass, ELEMENT_PREFIX + property);

        if (clazz == null) {
            clazz = (Class) JDSConverter.getInstance()
     ...
     * @param parentClass the Class which contains as a property the Map or Collection we are finding the key for.
     * @param property    the property of the Map or Collection for the given parent class
     * @see net.ooder.jds.core.esb.util.ObjectTypeDeterminer#getKeyProperty(Class, String)
     */
    public String getKeyProperty(Class parentClass, String property) {
    

        return (String) JDSConverter.getInstance().getConverter(parentClass, KEY_PROPERTY_PREFIX + property);
    }
    ...
    public boolean shouldCreateIfNew(Class parentClass,
        ...
        String configValue = (String) JDSConverter.getInstance().getConverter(parentClass, CREATE_IF_NULL_PREFIX + property);
