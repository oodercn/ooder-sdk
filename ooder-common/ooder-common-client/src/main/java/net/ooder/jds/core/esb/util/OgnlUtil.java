...
public class OgnlUtil {
    ...
    public static void setProperties(Map props, Object o, Map context) {
        setProperties(props, o, context, false, true);
    }
     ...
     */
    public static void setProperties(Map props, Object o, Map context, boolean throwPropertyExceptions, boolean throwwarn) {
        if (props == null) {
            return;
        }

        Ognl.setTypeConverter(context, JDSConverter.getInstance());
        ...
        for (Iterator iterator = props.entrySet().iterator();
            ...
            if (!o.getClass().isArray()){
                Field field = TypeUtils.getField(o.getClass(), expression, o.getClass().getDeclaredFields());
                if (field != null) {
                    object = TypeUtils.cast(object, field.getGenericType(), ParserConfig.getGlobalInstance());
                }
            }
            internalSetProperty(expression, object, o, context, throwPropertyExceptions, throwwarn);
        }
    ...
    public static void setProperties(Map properties, Object o, boolean throwPropertyExceptions) {
        ...
        setProperties(properties, o, context, throwPropertyExceptions, true);
    }

    public static void setProperties(Map properties, Object o, boolean throwPropertyExceptions, boolean throwwarn) {
        Map context = Ognl.createDefaultContext(o);
        setProperties(properties, o, context, throwPropertyExceptions, throwwarn);
    }
    ...
    public static void setProperty(String name, Object value, Object o, Map context, boolean throwPropertyExceptions) {
        setProperty(name, value, o, context, throwPropertyExceptions, true);
    }
    ...
    public static void setProperty(String name, Object value, Object o, Map context, boolean throwPropertyExceptions, boolean throwwarn) {
        ...
        internalSetProperty(name, value, o, context, throwPropertyExceptions, throwwarn);
    ...
    public static <T> T getValue(String name, Map context, Object root, Class<T> resultType) throws OgnlException {
     ...
     * using specified type converter, or {@link net.ooder.jds.core.esb.util.JDSMethodAccessor} if none
     * is specified.
     *
    ...
    public static void copy(Object from, Object to, Map context, Collection exclusions, Collection inclusions) {
        ...
        Ognl.setTypeConverter(contextFrom, JDSConverter.getInstance());
        Map contextTo = Ognl.createDefaultContext(to);
        Ognl.setTypeConverter(contextTo, JDSConverter.getInstance());
    ...
    static void internalSetProperty(String name, Object value, Object o, Map context, boolean throwPropertyExceptions, boolean throwwarn) {
        try {
