 ...
 */
/**
 * $RCSfile: InstantiatingNullHandler.java,v $
 * $Revision: 1.0 $
 * $Date: 2025/08/25 $
 * <p>
 ...
 * only during the execution of the {@link net.ooder.jds.core.esb.interceptor.ParametersInterceptor}), OGNL expressions
 ...
 * ObjectFactory#buildBean(Class, Map)} method.</li>
 *
 * </ul>
 *
 * <!-- END SNIPPET: javadoc -->
...
public class InstantiatingNullHandler implements NullHandler {
    ...
    public static final String CREATE_NULL_OBJECTS = "jdsesd.NullHandler.createNullObjects";
