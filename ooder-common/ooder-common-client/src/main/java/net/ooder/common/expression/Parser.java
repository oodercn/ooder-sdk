...
import net.ooder.common.expression.function.logical.*;
import net.ooder.common.expression.function.math.*;

public class Parser /*@bgen(jjtree)*/
    implements ParserTreeConstants, ParserConstants { /*@bgen(jjtree)*/
  protected JJTParserState jjtree = new JJTParserState();
  private JEP jep;

  public Node parseStream(java.io.Reader stream, JEP jep_in) throws
      ParseException {
    ReInit(stream);
    jep = jep_in;
    ...
    label_6:while (true) {
      ...
      if (jj_2_3(1)) {
        ...
        try {
          ...
          if (!jep.implicitMul) {
            if (true){
                Node errorNode = jjtn001.jjtGetChild(0);
              throw new ParseException(
//                  "Syntax Error (implicit multiplication not enabled)");
//                      "Syntax Error !" + jjtn001.getName());
  ...
  final public void Function() throws ParseException {
    ...
    try {
      ...
      if (jep.funTab.containsKey(identString)) {
        ...
        reqArguments =
            ( (FunctionI) jep.funTab.get(identString)).
...
*/
  ...
  final public void ArgumentList(int reqArguments, String functionName) throws
      ParseException {
    int count = 0;
    String errorStr = "";
    if (jj_2_6(1)) {
  ...
  final private int[] jj_la1_0 = {
      0x1, 0x100000, 0x80000, 0x48000, 0x48000, 0x36000, 0x36000, 0x600000,
      0x600000, 0x3800000, 0x4600000, 0x8000000, 0x400, 0x800002a0, 0x10000000,
      0x40000000, 0x800002a0, 0x40000000, 0xa0, };
